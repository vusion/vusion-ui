module.exports = {
    ...
    docs: {
        ...
        components: [
            { group: 'Basic', name: 'base', alias: '基础' },
            { group: 'Basic', name: 'typography', alias: '排印' },
            { group: 'Basic', name: 'u-text', alias: '文本' },
            { group: 'Basic', name: 'u-link', alias: '链接', path: 'cloud-ui.vusion/src/u-link.vue/README.md' },
            { group: 'Basic', name: 'u-link-list', alias: '链接列表', path: 'cloud-ui.vusion/src/u-link-list.vue/README.md' },
            ...
            { group: 'Basic', name: 'u-icon', alias: '图标', path: 'cloud-ui.vusion/src/u-icon.vue/README.md' },
            { group: 'Basic', name: 'u-status-icon', alias: '状态图标', path: 'cloud-ui.vusion/src/u-status-icon.vue/README.md' },
            { group: 'Basic', name: 'u-logo', alias: '标识', path: 'cloud-ui.vusion/src/u-logo.vue/README.md' },
            { group: 'Layout', name: 'u-linear-layout', alias: '线性布局', path: 'cloud-ui.vusion/src/u-linear-layout.vue/README.md' },
            ...
            { group: 'Feedback', name: 'u-loading', alias: '加载中', path: 'cloud-ui.vusion/src/u-loading.vue/README.md' },
            ...
            { group: 'Progress & Chart', name: 'u-linear-progress', alias: '线形进度条', path: 'cloud-ui.vusion/src/u-linear-progress.vue/README.md' },
            { group: 'Progress & Chart', name: 'u-circular-progress', alias: '环形进度条', path: 'cloud-ui.vusion/src/u-circular-progress.vue/README.md' },
            { group: 'Progress & Chart', name: 'u-chart', alias: '图表', path: 'cloud-ui.vusion/src/u-chart.vue/README.md' },
            { group: 'Progress & Chart', name: 'u-bar-chart', alias: '柱状图', path: 'cloud-ui.vusion/src/u-bar-chart.vue/README.md' },
            { group: 'Progress & Chart', name: 'u-xbar-chart', alias: '水平柱状图', path: 'cloud-ui.vusion/src/u-xbar-chart.vue/README.md' },
            { group: 'Progress & Chart', name: 'u-line-chart', alias: '线状图', path: 'cloud-ui.vusion/src/u-line-chart.vue/README.md' },
            { group: 'Progress & Chart', name: 'u-pie-chart', alias: '饼状图', path: 'cloud-ui.vusion/src/u-pie-chart.vue/README.md' },
